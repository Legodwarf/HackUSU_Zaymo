...
def jobOutput(query, country="us"):
...
dotenv_loaded = _load_dotenv_if_present("streamlit/.env")
...
resume_path = "streamlit/AI Ready Resume.docx"
...
def generate_gemini_response(doc, job): #job_dict
    ...
    with open("streamlit/gemini_response_text_test", "w", encoding="utf-8") as file:
